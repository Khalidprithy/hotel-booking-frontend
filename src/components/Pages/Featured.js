...
const Featured = () => {
    ...
    return (
        <div className='mt-40 md:mt-16 grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4 mx-4 z-10'>
            {loading ? ("Please Wait") : <>

                <div className='relative mx-auto'>
                    <img className='w-72 md:w-full object-fill rounded-lg' src={dhaka} alt="" />
                ...
                <div className='relative mx-auto'>
                    <img className='w-72 md:w-full object-fill rounded-lg' src={cox} alt="" />
                    <div className='absolute bottom-5 left-5 text-white'>
                ...
                <div className='relative mx-auto'>
                    <img className='w-72 md:w-full object-fill rounded-lg' src={sylhet} alt="" />
                    <div className='absolute bottom-5 left-5 text-white'>
